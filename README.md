...
> [!TIP]
> Real-time air quality data for our 8 global hubs is updated every 24 hours.
> 
> **[📊 View the Latest Daily Statistics here](./STATS.md)**
...
├── notebooks/
│   └── aq_chronos.ipynb                 # Core analysis and forecasting notebook
...
- An **OpenAQ API Key**. You can obtain one for free by creating an account at [OpenAQ Explorer](https://explore.openaq.org/#1.2/20/40).

### 2. Installation and Setup

```bash
# Clone the repository
git clone [https://github.com/GianmariaRomano/AQ-Chronos.git](https://github.com/GianmariaRomano/AQ-Chronos.git)
cd AQ-Chronos
...
Open ```notebooks/aq_chronos.ipynb``` in Jupyter to run the Prophet forecasting model, generate the ```aq_chronos_air_map.html``` file and view model diagnostics.
...
**N.B.:** When you save this to your local `README.md`, make sure to run `git pull origin main --rebase` before you push, just in case the GitHub Action bot has already made a commit today.
